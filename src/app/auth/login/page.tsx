...
import { Eye, EyeOff, ArrowRight, AlertCircle, Loader2, Globe } from "lucide-react";
...
function LoginForm() {
  ...
  return (
    <div className="w-full flex flex-col justify-between h-full min-h-[480px]">
      {/* Top Header Bar */}
      ...
      <div className="my-auto max-w-sm w-full mx-auto py-2">
        ...
        {/* Error Alert */}
        {error && (
          <div className="mb-4 p-3 rounded-lg bg-rose-500/10 border border-rose-500/20 flex items-start gap-2.5 text-rose-300 text-xs">
        ...
        <form onSubmit={handleSubmit} className="space-y-3.5">
          ...
          <div>
            ...
            <div className="flex justify-end mt-1.5">
              <span className="text-[11px] text-slate-400 hover:text-amber-400 transition-colors cursor-pointer">
                Forgot password?
              </span>
            </div>
          </div>
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full mt-2 py-3 rounded-lg bg-amber-400 hover:bg-amber-300 text-slate-950 text-xs font-bold uppercase tracking-wider transition-all shadow-md shadow-amber-400/20 flex items-center justify-center gap-2 cursor-pointer disabled:opacity-60 disabled:cursor-not-allowed"
          >
            {isLoading ? (
              <>
      ...
      {/* Bottom Social Icons */}
      <div className="flex items-center justify-center gap-5 pt-6 text-slate-500">
